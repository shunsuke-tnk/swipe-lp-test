...
export default function HeatmapPage() {
  ...
  useEffect(() => {
    ...
    const fetchHeatmap = async () => {
      setLoading(true);
      try {
        const response = await fetch(`/api/analytics/heatmap/${selectedSlide}`);
        if (response.ok) {
    ...
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 bg-gray-100 p-8">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-900">ヒートマップ</h1>
            <p className="text-gray-500 mt-1">クリック位置の可視化</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-white rounded-lg shadow p-4">
              <p className="text-sm text-gray-500">CTAクリック数</p>
              <p className="text-2xl font-bold text-gray-900">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mt-4 flex justify-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">中低</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 rounded-full bg-yellow-500" />
                <span className="text-sm text-gray-600">中高</span>
              </div>
              <div className="flex items-center gap-2">
